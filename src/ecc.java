...
public class ecc {
    ...
    public static void main( String[] args , String fname) {
        ...
        try {
            ...
            switch (ch){
                case "E":
                {
                     encryptFile( fname, password );
                     break;
                   }
                case "D":
                {
                     decryptFile( fname, password );
                     break;
                    }
                default : {System.out.println("Wrong choice");main(args,fname);}   
          }
        } catch (IOException e) {
    ...
    public static void encryptFile(String fileName, String pass)
        ...
        Cipher cipher = ecc.makeCipher(pass, true);
    ...
    public static void decryptFile(String fileName, String pass)
        ...
        //Generate the cipher using pass:
        Cipher cipher = ecc.makeCipher(pass, false);
        ...
        FileOutputStream target = new FileOutputStream(new File(fileName+ ".decrypted"));
